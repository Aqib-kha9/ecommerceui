...
export const categories: Category[] = [
  ...
  { id: "2", name: "Beverages", icon: "https://images.unsplash.com/photo-1622483767028-3f66f32aef97?auto=format&fit=crop&q=80&w=200", productCount: 1200, color: "from-blue-500 to-cyan-500" },
...
export const products: Product[] = [
  ...
  {
    id: "p3",
    name: "Gourmet Roasted Coffee Beans",
    price: 599,
    originalPrice: 750,
    rating: 4.9,
    reviews: 1230,
    images: [
      "https://images.unsplash.com/photo-1559056191-753bc6689403?auto=format&fit=crop&q=80&w=600",
    ...
    badge: "Top Rated",
    inStock: true,
    description: "Medium roast Arabica coffee beans sourced from the hills of Coorg.",
    tags: ["coffee", "beverage", "roasted"],
  },
  {
    id: "p4",
    name: "Herbal Green Tea Pack (100 Bags)",
    price: 449,
    originalPrice: 599,
    rating: 4.6,
    reviews: 560,
    image: "https://images.unsplash.com/photo-1627435601361-ec25f5b110e6?w=400&h=400&fit=crop",
    category: "Beverages",
    vendorId: "v1",
    vendorName: "FreshMart Essentials",
    inStock: true,
    description: "Rich in antioxidants, our organic green tea helps in detoxification and weight management.",
    tags: ["tea", "health", "antioxidant"],
  },
  {
    id: "p5",
